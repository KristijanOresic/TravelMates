...
export default function AdminPage() {
  ...
  if (loading) return <div className="loading"><h2>Učitavanje...</h2></div>;
  if (!userData) return <div className="not-logged"><h2>Niste prijavljeni</h2></div>;
  if (userData.role !== "admin") return <div className="access-denied"><h2>Pristup odbijen</h2></div>;
  ...
  return (
    <>
      ...
      <div className="admin-container">
        ...
        <button onClick={logout} className="logout-btn">Odjava</button>
